    ...
    const servicesCardConfig = [
        {
            name: 'description',
            title: 'Tài liệu',
            link: `/lecturer/classes/${classId}/documents` as Href<string>,
        },
        {
            name: 'assignment',
            title: 'Bài tập',
            link: `/lecturer/classes/${classId}/assignments` as Href<string>,
        },
        {
            name: 'groups',
            title: 'Điểm danh',
            link: `/lecturer/classes/${classId}/attendances` as Href<string>,
        },
    ];
    useEffect(() => {
        setIsLoading(true);
