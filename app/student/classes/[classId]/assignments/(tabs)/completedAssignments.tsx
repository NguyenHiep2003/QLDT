...
const CompletedAssignment: React.FC = () => {
  ...
  const loadAssignments = async () => {
    try {
      setLoading(true);
      const data = await fetchAssignments('COMPLETED', classId as string);
  ...
  return (
    <SectionList
      ...
      renderSectionHeader={({ section: { title, data } }) => {
        ...
        let comparisonText = '';
        comparisonText = deadlineDate.toLocaleDateString('vi-VN', { weekday: 'long' });
